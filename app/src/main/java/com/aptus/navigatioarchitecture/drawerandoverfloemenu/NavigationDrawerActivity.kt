...
class NavigationDrawerActivity : AppCompatActivity(),HomeFragment.OnFragmentInteractionListener,NavFirstFragment.OnFragmentInteractionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setUpDrawerToggle()
        NavigationUI.setupWithNavController(navView, Navigation.findNavController(this, R.id.navDrawerActivity))
    }
